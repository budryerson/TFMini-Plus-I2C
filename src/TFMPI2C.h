...
// These following TFMini-Plus commands are not used in this library.
...
// pin #3 becomes a binary, hi/lo output.  Thereafter, only Pin #2, the Serial RX
// line, is functional and only serial communication with the device is possible.
